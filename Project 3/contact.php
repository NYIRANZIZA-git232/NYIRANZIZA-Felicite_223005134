...
<head>
    ...
    <title>Grand Palace Hotel - Contact Us</title>
        ...
        <div class="container">
            ...
            <div class="contact-grid">
                <div class="contact-info">
                    <h2>Get in Touch</h2>
                    <p style="color: var(--text-muted); margin-bottom: 30px;">Have a question or feedback? We're here to help. Reach out to us through any of the following channels.</p>
                    
                    <div class="contact-item">
                        <span><i class="fas fa-map-marker-alt"></i></span>
                        <div>
                            <h4>Location</h4>
                            <p>KG 123 Street City, 12 AVE</p>
                        </div>
                    </div>
